    ...
    <div className="w-[100vw] snap-mandatory snap-y">
      ...
      <div className="py-8 px-4">
        <div className="flex flex-col justify-center items-center">
          <div className="text-xl lg:text-2xl text-center pt-10 pb-5">CATEGORIES</div>
        ...
        <div className="flex justify-center py-4 sm:py-10">
          <button className="border-4 border-slate-700 px-6 py-3 rounded-full text-sm sm:text-lg hover:bg-slate-700 hover:text-white">VIEW ALL</button>
        </div>
      </div>
    </div>
  )
